...
const manuals = [
    ...
    {
        path: "driver-recommendations.md",
        language: "en",
        id: "driver-recommendations-en",
    },
    ...
    {
        path: "de/driver-recommendations.md",
        language: "de",
        id: "driver-recommendations-de",
    },
] as const;
...
const alertIcons = {
    ...
    IMPORTANT:
        '<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M8 1.75 9.7 6.3l4.55.2-3.55 2.85 1.2 4.4L8 11.2l-3.9 2.55 1.2-4.4L1.75 6.5l4.55-.2L8 1.75Z" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/></svg>',
    WARNING:
        '<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M8 2.1 14.25 13H1.75L8 2.1Z" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linejoin="round"/><path d="M8 6v3.5M8 11.65h.01" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',
    CAUTION:
        '<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M5.2 1.75h5.6L14.25 5.2v5.6l-3.45 3.45H5.2L1.75 10.8V5.2L5.2 1.75Z" fill="none" stroke="currentColor" stroke-width="1.4"/><path d="M8 5v3.5M8 10.75h.01" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',
...
const main = async () => {
    ...
    try {
        ...
        const styles = createStyles(
            (await readFile(fontPath)).toString("base64"),
        );
