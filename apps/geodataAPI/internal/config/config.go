...
func Load() (Config, error) {
	cfg := Config{
		...
		ReloaderURL:    strings.TrimRight(strings.TrimSpace(os.Getenv("GEODATA_RELOADER_URL")), "/"),
	...
	if cfg.ReloadTimeout, err = durationEnv("GEODATA_RELOAD_TIMEOUT", 2*time.Minute); err != nil {
		return Config{}, err
	}
